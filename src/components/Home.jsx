                ...
                <div className="lg:col-span-2 space-y-6">
                    ...
                    <div className="bg-white rounded-2xl border border-slate-200 shadow-sm overflow-hidden">
                        {[
                            ...
                            <div key={i} className={`flex items-center justify-between p-4 ${i !== 2 ? 'border-b border-slate-50' : ''} hover:bg-slate-50 transition-colors`}>
                                <div className="flex items-center gap-4">
                                    <span className="text-xl">{leader.badge}</span>
                                    <div>
                                        <div className="font-semibold text-slate-900 text-sm">{leader.name}</div>
                                        <div className="text-xs text-slate-500">{leader.region}</div>
                                    </div>
                                </div>
                                <div className="text-right">
                                    <div className="font-bold text-blue-700">{leader.score}</div>
                                </div>
                            </div>
                        ))}
                    </div>
