...
export default function RadioMiniPlayer({ language, currentView, suppressChrome = false }) {
  const hideChrome = suppressChrome || currentView === 'community' || currentView === 'sops';
  const {
    audioRef,
    bgAudioRef,
    visible,
