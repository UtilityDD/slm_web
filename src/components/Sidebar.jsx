...
export default function Sidebar({
  ...
  const menuItems = [
    ...
    { id: 'admin', label: userProfile?.role === 'lineman' ? (language === 'en' ? 'My Profile' : 'আমার প্রোফাইল') : (language === 'en' ? 'Update Profile' : 'প্রোফাইল আপডেট'), icon: '⚙️', show: ['admin', 'safety mitra', 'lineman'].includes(userProfile?.role) },
