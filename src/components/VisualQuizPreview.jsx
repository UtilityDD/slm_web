...
import {
    ...
    VISUAL_QUIZ_CONTROL_ROOM_PREVIEW_URL,
...
const SOURCES = {
    ...
    controlRoomPreview: {
        id: 'controlRoomPreview',
        labelBn: 'Draft: Control room teamwork',
        labelEn: 'Draft: Control room teamwork',
        url: VISUAL_QUIZ_CONTROL_ROOM_PREVIEW_URL,
    },
    ladderPreview: {
        id: 'ladderPreview',
        labelBn: 'Draft: Ladder use',
        labelEn: 'Draft: Ladder use',
        url: VISUAL_QUIZ_LADDER_PREVIEW_URL,
    },
    transformerTroubleshootingPreview: {
        id: 'transformerTroubleshootingPreview',
        labelBn: 'Draft: Transformer troubleshooting',
        labelEn: 'Draft: Transformer troubleshooting',
        url: VISUAL_QUIZ_TRANSFORMER_TROUBLESHOOTING_PREVIEW_URL,
    },
    switchyardPreview: {
        id: 'switchyardPreview',
        labelBn: 'Draft: Switchyard safe work',
