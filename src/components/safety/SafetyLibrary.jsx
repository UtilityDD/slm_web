                    ...
                    <div className="fixed inset-0 z-[1000] flex items-end sm:items-center justify-center p-0 sm:p-6 animate-fade-in">
                        ...
                        <div className="relative w-full h-[95vh] sm:h-auto sm:max-w-2xl bg-white dark:bg-slate-900 rounded-t-[3rem] sm:rounded-[2.5rem] shadow-2xl flex flex-col overflow-hidden animate-slide-up sm:animate-scale-in border-t border-white/10">
                            ...
                            <div className="flex-1 overflow-y-auto no-scrollbar">
                                {/* Top Image Section with Overlaid Title & Category */}
                                <div className="relative w-full aspect-square sm:aspect-video bg-slate-50 dark:bg-slate-800/20 group/modal-img">
                                    ...
                                    {/* Top Protective Gradient & Text Overlay */}
                                    <div className="absolute top-0 left-0 right-0 p-6 sm:p-8 bg-gradient-to-b from-black/60 via-black/20 to-transparent pointer-events-none">
                                        <div className="space-y-1 animate-in slide-in-from-top-4 duration-500">
                                            <span className="inline-block px-2.5 py-1 bg-orange-500 text-white text-[9px] font-black uppercase tracking-[0.2em] rounded-md shadow-lg shadow-orange-500/20 border border-orange-400/50">
                                                {selectedItem.category}
                                            </span>
                                            <h3 className="text-xl sm:text-3xl font-black text-white drop-shadow-md leading-tight max-w-[85%]">
