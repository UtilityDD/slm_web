...
const DataCollectionTab = ({ content }) => {
            ...
            <section>
                ...
                <div className="grid gap-6">
                    {content.cards?.map((card, index) => (
                        <div key={index} className={`p-5 bg-${card.color}-50 dark:bg-${card.color}-900/10 rounded-2xl border-l-4 border-${card.color}-500`}>
                            <h3 className={`font-bold text-${card.color}-700 dark:text-${card.color}-400 mb-2 flex items-center gap-2`}>
