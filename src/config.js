...
export const CURRENT_APP_VERSION = "1.3.106";
/** Shown in the update modal when CURRENT_APP_VERSION changes. */
export const CURRENT_APP_RELEASE_NOTES = {
  en: "Please update — Home tip board, faster profile photo, and small Home polish.",
  bn: "নতুন ভার্সন আপডেট করুন—হোমে টিপ বোর্ড, দ্রুত প্রোফাইল ছবি, আর ছোটখাটো পরিষ্কার।",
};
 ...
 */
export const ANDROID_VERSION_CODE = 106;
