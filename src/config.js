...
export const CURRENT_APP_VERSION = "1.3.152";
/** Shown in the update modal when CURRENT_APP_VERSION changes. */
export const CURRENT_APP_RELEASE_NOTES = {
  en: "Faster All-time Rank with full reading scores from the saved ledger.",
  bn: "অল-টাইম র‍্যাঙ্ক দ্রুত — পূর্ণ পড়ার স্কোর এখন সেভ করা লেজার থেকে।",
};
 ...
 */
export const ANDROID_VERSION_CODE = 146;
