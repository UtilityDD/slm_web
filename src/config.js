...
export const CURRENT_APP_VERSION = "1.3.105";
/** Shown in the update modal when CURRENT_APP_VERSION changes. */
export const CURRENT_APP_RELEASE_NOTES = {
  en: "Please update — Rank opens faster from cache.",
  bn: "নতুন ভার্সন আপডেট করুন—র‍্যাঙ্ক এখন দ্রুত খুলবে।",
};
 ...
 */
export const ANDROID_VERSION_CODE = 105;
