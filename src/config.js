...
export const CURRENT_APP_VERSION = "1.3.98";
/** Shown in the update modal when CURRENT_APP_VERSION changes. */
export const CURRENT_APP_RELEASE_NOTES = {
  en: "v1.3.98 — Home: clearer 2-column shortcuts; tip title without light sweep.",
  bn: "v1.3.98 — হোম: স্পষ্ট ২-কলাম শর্টকাট; টিপ শিরোনামে লাইট অ্যানিমেশন নেই।",
};
 ...
 */
export const ANDROID_VERSION_CODE = 98;
