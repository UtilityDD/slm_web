...
export const CURRENT_APP_VERSION = "1.3.97";
/** Shown in the update modal when CURRENT_APP_VERSION changes. */
export const CURRENT_APP_RELEASE_NOTES = {
  en: "v1.3.97 — Landing: cleaner Join button (hand icon removed).",
  bn: "v1.3.97 — ল্যান্ডিং: যোগ দিন বাটন পরিষ্কার (হাত আইকন সরানো)।",
};
 ...
 */
export const ANDROID_VERSION_CODE = 97;
