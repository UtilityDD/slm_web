...
export const CURRENT_APP_VERSION = "1.3.120";
/** Shown in the update modal when CURRENT_APP_VERSION changes. */
export const CURRENT_APP_RELEASE_NOTES = {
  en: "Please update — bug fix: culture survey submit no longer fails with Auth session missing.",
  bn: "নতুন ভার্সন আপডেট করুন—বাগ ঠিক: জরিপ জমায় Auth session missing আর আসবে না।",
};
 ...
 */
export const ANDROID_VERSION_CODE = 120;
