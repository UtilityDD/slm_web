...
export const CURRENT_APP_VERSION = "1.3.102";
/** Shown in the update modal when CURRENT_APP_VERSION changes. */
export const CURRENT_APP_RELEASE_NOTES = {
  en: "v1.3.102 — Landing polish, Home My PPE + Identify, and simpler language/Facebook footer.",
  bn: "v1.3.102 — ল্যান্ডিং পরিষ্কার, হোমে আমার পিপিই ও চিনুন, এবং সহজ ভাষা/ফেসবুক ফুটার।",
};
 ...
 */
export const ANDROID_VERSION_CODE = 102;
