...
export const CURRENT_APP_VERSION = "1.3.137";
/** Shown in the update modal when CURRENT_APP_VERSION changes. */
export const CURRENT_APP_RELEASE_NOTES = {
  en: "Please update — New guide video uploaded.",
  bn: "নতুন ভার্সন আপডেট করুন—নতুন গাইড ভিডিও আপলোড হয়েছে।",
};
 ...
 */
export const ANDROID_VERSION_CODE = 134;
