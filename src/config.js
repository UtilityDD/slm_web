...
export const CURRENT_APP_VERSION = "1.3.173";
/** Shown in the update modal when CURRENT_APP_VERSION changes. */
export const CURRENT_APP_RELEASE_NOTES = {
  en: "Some bugs fixed. Some new updates. Some new quiz added.",
  bn: "কিছু বাগ ঠিক করা হয়েছে। কিছু নতুন আপডেট। কিছু নতুন কুইজ যোগ হয়েছে।",
};
 ...
 */
export const ANDROID_VERSION_CODE = 165;
