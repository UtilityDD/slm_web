...
export const CURRENT_APP_VERSION = "1.3.136";
/** Shown in the update modal when CURRENT_APP_VERSION changes. */
export const CURRENT_APP_RELEASE_NOTES = {
  en: "Please update — Team reminders: confirm who to message, then tap WhatsApp or SMS one person at a time. Dual WhatsApp can be remembered.",
  bn: "নতুন ভার্সন আপডেট করুন—আমার টিম: যাদের পাঠাবেন বাছাই করুন, তারপর একজন করে WhatsApp বা SMS খুলুন। দুই WhatsApp থাকলে মনে রাখা যায়।",
};
 ...
 */
export const ANDROID_VERSION_CODE = 133;
